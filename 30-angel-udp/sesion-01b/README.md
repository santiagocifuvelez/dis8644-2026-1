...
**Electricidad - Analogía: Agua**

*Cadudal = Altura/Oposición que es inversamnete proporcional*

entre más arriba más caudal, o menos arriba menos caudal

**Ahora aplicado en la Electricidad**

Corriente (I) = intencidad de corriente, Resistencia (R), Voltaje (v)

*Corriente-Ampere (I) = Voltaje-Volts (V)/Resistencia (R) OHM "omega". es la formula I=V/R*

+ LED

Catodo-Negativo (Parte corta)

Ánodo-Positivo (Parte larga)

**La resistencia no tiene polaridad (parte que controla el flujo de los electrones)**

Un cable no es una linea, es un NODO

Puente (cable = Mismo punto)

e- Electrón = en griego Ambar

Electrón es una partícula que es parte de un átomo

Know-How, Know-What: Historia
